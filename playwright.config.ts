...
export default defineConfig({
  ...
  webServer: {
    command: `SUPALUV_E2E_WEB_PORT=${webPort} VITE_ENABLE_POSTHOG=false VITE_SUPALUV_COPLAY_TRANSPORT=broadcast VITE_SWIMMER_BACKEND_SUPABASE_URL=https://e2e.supabase.co VITE_SWIMMER_BACKEND_PUBLISHABLE_KEY=e2e-public-key pnpm --filter @supaluv/web dev`,
    url: webBaseUrl,
